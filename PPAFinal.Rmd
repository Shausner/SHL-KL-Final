...
```{r Summary of Overdoses by Patient Demographics, Incident Outcome and Time Reported,message=FALSE, warning=FALSE, include = FALSE, results='markdown'}
...
```{r Spatial Distribution and Overdose Hotspots,message=FALSE, warning=FALSE, include = FALSE, results='markdown'}
...
```{r Spatial Distribution of Risk Factors,message=FALSE, warning=FALSE, include = FALSE, results='markdown'}
...
```{r Spatial Distribution of Nearest Neighbor Risk Factors,message=FALSE, warning=FALSE, include = FALSE, results='markdown'}
vars_net.long.nn <- 
...
```{r Variable Correlation, fig.height=10, fig.width=10,message=FALSE, warning=FALSE, include = FALSE, results='markdown'}
...
```{r Regressions and Cross Validation, fig.height=10, fig.width=10,message=FALSE, warning=FALSE, include = FALSE, results='markdown'}
...
```{r Kernel Density and Risk Prediction,message=FALSE, warning=FALSE, include = FALSE, results='markdown'}
...
```{r Reported Overdoses by City Council District,message=FALSE, warning=FALSE, include = FALSE, results='markdown'}
